...
# We set the sizes of the training and validation datasets
train_size = 50000
val_size = 10000
...
def compute_epoch_loss(model, data_loader, criterion):
    # It computes the loss of the <model> on the dataset's <data_loader> for one epoch using <criterion>
...
if __name__ == '__main__':
    ...
    ae = AutoEncoder(dims=layers_dimensions, bias=True)
